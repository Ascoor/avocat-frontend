...
function CourtSearch () {
    ...
    const formAnimation = useSpring({ opacity: 1, marginTop: 0, from: { opacity: 0, marginTop: -100 } });

    const handleDegreeSelect = async (event) => {
        const selectedDegree = event.target.value;
        setSelectedDegree(selectedDegree);
        const response1 = await fetch(`${API_CONFIG.baseURL}/api/search/court-options/${selectedDegree}`);
    ...
    const handleCourtSelect = async (event) => {
        ...
        const response = await fetch(`${API_CONFIG.baseURL}/search/case-type-options/${selectedCourt}`);
        const data = await response.json();
                ...
                <Form onSubmit={handleSearchSubmit}>
                    <Form.Group controlId="degreeSelect">
                        ...
                        <Form.Control as="select" value={selectedDegree} onChange={handleDegreeSelect}>
                            ...
                            {degreeOptions.length > 0 && degreeOptions.map((degree) => (
                    ...
                    <Form.Group controlId="courtSelect">
                        ...
                        <Form.Control as="select" value={selectedCourt} onChange={handleCourtSelect}>
                            <option value="">Select</option>
                    ...
                    <Form.Group controlId="caseTypeSelect">
                        ...
                        <Form.Control as="select" value={selectedCaseType} onChange={handleCaseTypeSelect}>
                            <option value="">Select</option>
                    ...
                    <Form.Group controlId="caseYearInput">
                        ...
                        <Form.Control type="text" value={caseYear} onChange={handleCaseYearInput} />
                    </Form.Group>

                    <Form.Group controlId="caseNumberInput">
                        <Form.Label>Case Number:</Form.Label>
                        <Form.Control type="text" value={caseNumber} onChange={handleCaseNumberInput} />
                    </Form.Group>
