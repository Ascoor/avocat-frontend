      ...
      <Card.Body>
        ...
        <Modal show={showAddModal} onHide={() => setShowAddModal(false)}>
          <Modal.Header className="modal-header" >
            <Modal.Title className="modal-title">إضافة بيانات المحامي</Modal.Title>
            <Button  onClick={handleCloseAddModal}  className="btn-close  btn-warning">
                    </Button>
          </Modal.Header>
          <Modal.Body>
        ...
        <Modal show={showEditModal} onHide={() => setShowEditModal(false)}>
          <Modal.Header >
            <Modal.Title>تعديل بيانات المحامي</Modal.Title>
            <Button variant="warning" onClick={handleCloseEditModal} className="btn-close">
