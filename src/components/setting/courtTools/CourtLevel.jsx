...
import axios from "axios";
    ...
    return (
        <>
              ...
              <Card>
                <Row>
                  <Col>
                    ...
                    <Button onClick={() => setShowAddCourtLevelModal(true)} variant="primary" >
                      إضافة درجة المحكمة
                    </Button>
          ...
          <Modal show={showAddCourtLevelModal} onHide={() => setShowAddCourtLevelModal(false)}>
            ...
            <Form>
                            <Form.Group controlId="courtLevelName">
                                ...
                                <Form.Control
                                    ...
                                    onChange={(e) =>
                                        setNewCourtLevelName(e.target.value)
                                    }
                                />
                            </Form.Group>
                        </Form>
            ...
            <Modal.Footer>
              <Button variant="secondary" onClick={() => setShowAddCourtLevelModal(false)}>
                إغلاق
              </Button>
