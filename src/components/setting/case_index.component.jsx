    ...
    return (<Card>
        ...
        <Row>
            <ButtonGroup aria-label="Basic example">
                ...
                <Button onClick={() => setShowAddLegalAdModal(true)} variant="success">
                    إضافة نوع إعلان
                </Button>
            </ButtonGroup>
        </Row>
        <Card.Body>
                                ...
                                >
                                    ...
                                    <td>
                                        <Button
                                            variant="danger"
                                            onClick={() =>
                                                handleDelete(caseType.id, caseType.name, "case_types")
                                            }
                                        >
                                            حذف
                                        </Button>
            ...
            <>
                ...
                <Modal show={showAddLegalAdModal} onHide={() => setShowAddLegalAdModal(false)}>
                    <Modal.Header closeButton>
                    ...
                    <Modal.Footer>
                        <Button variant="secondary" onClick={() => setShowAddLegalAdModal(false)}>
                            إغلاق
                        </Button>
