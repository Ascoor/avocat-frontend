    ...
    <section className="relative w-full max-w-lg max-h-[90vh] p-6 mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-y-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300">مكان الإجراء</label>
          <input
            type="text"
        ...
        <div>
          <label className="text-avocat-indigo dark:text-avocat-indigo-light">المحامي</label>
          <input
            type="text"
            value={
        ...
        <div>
<label className="text-avocat-indigo dark:text-avocat-indigo-light">حالة الإجراء</label>
      ...
      <div
          className={`block w-full px-4 py-2 mt-1 text-center rounded-md ${
            ...
            >
          {procedure.status === "null" || !procedure.status ? "فارغ" : procedure.status}
        </div>
         </div>
         
        <div className="col-span-2">
        <div>
              <label className="block text-avocat-blue-dark dark:text-avocat-indigo-light">تاريخ البدء</label>
              <input
                type="date"
                name="date_start"
            ...
            {/* Date End */}
            <div>
              <label className="block text-avocat-blue-dark dark:text-avocat-indigo-light">تاريخ الانتهاء</label>
              <input
                type="date"
                name="date_end"
                value={procedure.date_end} 
           v     className="block  w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600"
        ...
        <div className="col-span-2">
        <div>
          <label className="text-avocat-indigo dark:text-avocat-indigo-light">المطلوب</label>
          <input
            type="text"
            value={
          ...
          <label className="text-avocat-indigo dark:text-avocat-indigo-light">النتيجة</label>
          <textarea
            value={
...
          <textarea
            readOnly
            value={procedure.note === "null" || !procedure.note ? "" : procedure.note}
...
<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
  ...
  <div>
    ...
    <input
      type="text"
      value={procedure.cost1 === "null" || !procedure.cost1 ? "فارغ" : procedure.cost1}
      readOnly
  ...
  <div>
    ...
    <input
      type="text"
      value={procedure.cost2 === "null" || !procedure.cost2 ? "فارغ" : procedure.cost2}
      readOnly
      className="block w-full px-4 py-2 mt-1 border rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 focus:outline-none"
    />
  </div>
  ...
  <div>
    ...
    <input
      type="text"
      value={procedure.cost3 === "null" || !procedure.cost3 ? "فارغ" : procedure.cost3}
      readOnly
      className="block w-full px-4 py-2 mt-1 border rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 focus:outline-none"
    />
  </div>
...
<div className="col-span-2">
          <label className="text-sm font-medium text-gray-700 dark:text-avocat-indigo-light">محرر الإجراء</label>
          <input
            type="text"
