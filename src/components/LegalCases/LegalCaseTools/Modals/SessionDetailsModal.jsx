...
<label className="text-avocat-indigo dark:text-avocat-indigo-light">حالة الجلسة</label>
      ...
      <div
          className={`block w-full px-4 py-2 mt-1 text-center rounded-md ${
            ...
            >
          {session.status === "null" || !session.status ? "فارغ" : session.status}
        </div>
        </div>
...
<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
  ...
  <div>
    ...
    <input
      type="text"
      value={session.cost1 === "null" || !session.cost1 ? "فارغ" : session.cost1}
      readOnly
  ...
  <div>
    ...
    <input
      type="text"
      value={session.cost2 === "null" || !session.cost2 ? "فارغ" : session.cost2}
      readOnly
      className="block w-full px-4 py-2 mt-1 border rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 focus:outline-none"
    />
  </div>
  ...
  <div>
    ...
    <input
      type="text"
      value={session.cost3 === "null" || !session.cost3 ? "فارغ" : session.cost3}
      readOnly
      className="block w-full px-4 py-2 mt-1 border rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 focus:outline-none"
    />
</div>
