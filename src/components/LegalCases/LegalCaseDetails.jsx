  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-gray-50 dark:bg-gray-900 transition-all">
      ...
      <div className="bg-gradient-to-br from-pink-100 via-blue-100 to-cyan-200 dark:from-avocat-indigo dark:via-indigo-900 dark:to-avocat-indigo-darker p-8 rounded-xl shadow-2xl mt-8">
        <h2 className="text-2xl font-extrabold text-gray-800 dark:text-gray-100 mb-6 text-center">تفاصيل القضية</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {[
            ...
            { label: "تصنيف القضية", value: legCase.case_type?.name || "غير متوفر" },
            { label: "التصنيف الفرعي", value: legCase.case_sub_type?.name || "غير متوفر" },
            { label: "صفة الموكل", value: legCase.client_capacity || "غير متوفر" },
            { label: "الخصم", value: legCase.litigants_name || "غير متوفر" },
            { label: "عنوان الخصم", value: legCase.litigants_address || "غير متوفر" },
            { label: "محامي الخصم", value: legCase.litigants_lawyer_name || "غير متوفر" },
            { label: "رقم محامي الخصم", value: legCase.litigants_lawyer_phone || "غير متوفر" },
            ...
            <div
              ...
              className={`p-4 rounded-lg shadow-md hover:shadow-lg transition ${
                index % 2 === 0 ? "bg-pink-50 dark:bg-avocat-blue-darker text-center" : "bg-cyan-50 dark:bg-avocat-blue-darker text-center"
              }`}
            >
              <p className="text-lg font-bold text-gray-600 dark:text-gray-300 mb-1">{label}:</p>
              <p className={`text-md ${value === "غير متوفر" ? "text-red-500 dark:text-red-400" : "text-avocat-blue dark:text-avocat-orange"}`}>
                {value}
              </p>
            </div>
          ))}
