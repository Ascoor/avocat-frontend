  ...
  return (
    <>
      <div style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
        ...
        <p>
          Text Editor is designed to be a free to use online text manipulator
          that you can use for efficiency and productivity gains. Whether you
          have mistakenly written all your text in capital or you want to
          quickly align the correct capitalisation structure for titles. Text
          Editor allows you to quickly fix any errors as well as produce an
        ...
        <p>
          ...
          <a href="mailto:diliprk95@gmail.com">get in touch</a> with us and we
          will be more than happy to help you.
        </p>
        <p>
          <Link to="/word-editor" className="btn btn-primary">
