  ...
  return (
    ...
    >
      <Offcanvas.Header className="offcanvas-header">
        <Offcanvas.Title className="offcanvas-title m-3">
          الإعدادات
        </Offcanvas.Title>
      </Offcanvas.Header>
      <Offcanvas.Body>
        ...
        <ul className="sidebar-nav">
          ...
          <li>
            <Link className="nav-link" to="/cases_setting">
              <FaCog className="m-2" size={25} /> اعدادات القضايا
            </Link>
          </li>
        </ul>
      </Offcanvas.Body>
