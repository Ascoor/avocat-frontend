                ...
                <tbody>
                    {services.map((service) => (
                        <tr key={service.id}>
                            ...
                            <td>{service.client_id || service.unclient_name || service.unclient_phone}</td>
                            {/* أضف المزيد من الأعمدة للحقول الأخرى */}
                            <td>
                                <Button variant="info" onClick={() => handleEditService(service)}>تعديل</Button>
                                <Button variant="danger" onClick={() => handleDeleteService(service.id)}>حذف</Button>
                            </td>
                        </tr>
                    ))}
                </tbody>
