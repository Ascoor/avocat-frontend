        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full dark:text-gray-300">
            ...
            <thead className="text-xs uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700 dark:bg-opacity-50 rounded-sm">
              <tr>
                <th className="p-2">
                  <div className="font-semibold text-left">المصدر</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">الزوار</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">الإيرادات</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">المبيعات</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">معدل التحويل</div>
                </th>
              </tr>
            </thead>
            {/* جسم الجدول */}
