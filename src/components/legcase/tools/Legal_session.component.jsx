...
LegalSession.propTypes = {
    ...
    return (
        <>
            <Row>
                {showAlert && (
                    <Alert variant={alert.variant} onClose={() => setShowAlert(false)} dismissible>
                        {alert.message}
                    </Alert>
                )}
            </Row>
            ...
            <Card.Header>
                ...
                <Button variant="success" className="btn-sm" onClick={handleAddLegalSession}>
                    <BiPlusCircle className="mr-1" />إضافة جلسة
                </Button>
                        ...
                        <tbody>
                            {legalSessions.map((legalSession) => (
                                <tr key={legalSession.id}>
                                    ...
                                    <td>
                                        <Button variant="info" onClick={() => handleEditLegalSession(legalSession)}>
                                            <BiPencil />
                                        </Button>
                                    </td>
                                    <td>
                                        <Button variant="danger" onClick={() => handleDeleteLegalSession(legalSession.id)}>
                                            <BiTrash />
                                        </Button>
                                    </td>
                                </tr>
            ...
            <Modal show={showAddLegalSessionModal} onHide={handleCloseModal} centered size="lg">
