    ...
    <footer className="footer">
      <div className="container">
        <div className="row">
          ...
          <h3>تواصل معنا</h3>
            <p>
              يمكنك التواصل معنا باستخدام المعلومات التالية:
            </p>
            <p>
              البريد الإلكتروني: <a href="mailto:Avocat@Avocat.live">Avocat@Avocat.live</a>
            </p>
            <p>
            ...
            <p>
              العنوان: جمهورية مصر العربية - الدقهلية - المنصورة - شارع الجيش - برج التجارة - الدور 12
            </p>
          </div>
          <div className="col-md-4">
            <h3>ساعات العمل</h3>
          ...
          <div className="col-md-4">
            ...
            <a className="facebook" href="https://www.facebook.com/Avocat.Lawfirm/">
