      ...
      <div className="container my-5">
        <div className="row row-cols-1 row-cols-md-2 g-2 h-100 d-flex align-items-center">
          <div className="col contact-info">
            ...
            <p className="mb-4">
              نحن هنا لخدمتك وحماية حقوقك. يمكنك التواصل معنا باستخدام المعلومات التالية:
            </p>
            <div className="contact-details">
              <div className="d-flex align-items-center mb-3">
                <i className="bx bxs-envelope px-1"></i>
                <a className="email d-flex" href="mailto:Avocat@Avocat.live">Avocat@Avocat.live</a>
              </div>
              <div className="d-flex align-items-center mb-3">
                <i className="bx bxs-phone px-1"></i>
                <a className="email d-flex" href={`tel:050-2305699 | 011-22242888 | 011-14861131`}>050-2305699 | 011-22242888 | 011-14861131</a>
              </div>
              <div className="d-flex align-items-center mb-3">
                <i className="bx bxs-map"></i>
                <span className="email d-flex">جمهورية مصر العربية - الدقهلية - المنصورة - شارع الجيش - برج التجارة - الدور 12</span>
              </div>
            </div>
            ...
            <div className="working-hours">
              <div className="d-flex align-items-center">
                ...
                <span className="email d-flex">السبت - الخميس: 10 ص - 10 م</span>
              </div>
              <div className="d-flex align-items-center">
                <i className="bx bx-time"></i>
