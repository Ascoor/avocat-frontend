...
const fakeData = {
    ...
    sessions: [
      { date: "2025-01-10", time: "10:00 ص", description: "جلسة استماع لقضية الأحوال الشخصية" },
      { date: "2025-01-15", time: "1:00 م", description: "جلسة استئناف لقضية تجارية" },
    ...
    announcement_dates: [
      ...
      { date: "2025-02-09", description: "تسليم الإعلانات المتعلقة بالقضايا الجديدة" }
    ],
    tasks: [
      { task: "مراجعة ملف القضية رقم 123", dueDate: "2025-01-11", status: "قيد التنفيذ" },
